...
public class AsyncService {
	...
	{
		log.info("getEmployeePhone Starts");
		EmployeeProfiles employeeProfilesData = restTemplate.getForObject("http://localhost:8080/profiles", EmployeeProfiles.class);

		log.info("employeeProfileData, {}", employeeProfilesData);
		Thread.sleep(1000L);	//Intentional delay
		log.info("employeePhoneData completed");
